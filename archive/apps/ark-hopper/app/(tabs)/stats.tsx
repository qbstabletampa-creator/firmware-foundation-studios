...
export default function StatsTab() {
  // Single source of truth for "games played": arkHopperStore counts each
  ...
  const totalGamesPlayed = useArkHopperStore((s) => s.totalGamesPlayed);
  const currentStreak = useStreakStore((s) => s.currentStreak);
  const longestStreak = useStreakStore((s) => s.longestStreak);
  const highScore = useArkHopperStore((s) => s.highScore);
  const bestCombo = useArkHopperStore((s) => s.bestCombo);
  const totalStarsCollected = useArkHopperStore((s) => s.totalStarsCollected);
    ...
    <SafeAreaView style={styles.screen}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.statRow}>
          ...
          <StatBox label="Stars" value={totalStarsCollected} />
        </View>
        <View style={styles.statRow}>
