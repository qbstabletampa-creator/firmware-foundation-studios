...
// Algorithm is identical to packages/verses/selectionEngine.ts so the daily
// game and the daily verse set stay in sync.
// ---------------------------------------------------------------------------
...
/**
 * Hash a date string (e.g. "2026-06-08") into a 32-bit integer suitable for
