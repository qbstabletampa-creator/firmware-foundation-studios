...
// play() rewinds to the start (seekTo 0) then plays, so rapid repeats (card
// flips, button mashing) restart cleanly instead of being dropped.
//
...
//
// Canonical pattern: see archive/.pmloop/sound-spec.md. Kept identical across
// every FFS app so they share one Expo Go build and one mental model.
// ---------------------------------------------------------------------------
