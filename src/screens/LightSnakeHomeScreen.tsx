...
import styles from './LightSnakeHomeScreen.module.css';
      ...
      <div className={styles.container}>
        ...
        >
          <header className={styles.header}>
            ...
            >
              <img src="/light-snake-icon.png" alt="Light Snake" className={styles.logoImg} />
            </motion.div>
            <motion.button
              className={styles.settingsBtn}
              onClick={() => navigate('/light-snake/settings')}
              whileTap={{ scale: 0.95 }}
            >
              &#x2699;
            </motion.button>
          ...
          <h1 className={styles.gameTitle}>Light Snake</h1>
          <p className={styles.tagline}>Follow the light</p>
        </motion.div>
        ...
        <motion.button
          ...
          onClick={() => navigate('/light-snake/play')}
