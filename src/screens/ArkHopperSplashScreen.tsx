...
import styles from './ArkHopperSplashScreen.module.css';
...
export function ArkHopperSplashScreen() {
  ...
  useEffect(() => {
    ...
    const navTimer = setTimeout(() => {
      navigate(onboarded ? '/ark-hopper/home' : '/ark-hopper/onboarding', { replace: true });
    }, 2500);
    return () => {
      ...
      {visible && (
        ...
        >
          <div className={styles.center}>
            <div className={styles.logoWrap}>
              ...
              <motion.span
                ...
                transition={{
                  ...
                  scale: { delay: 0.2, duration: 0.8, type: 'spring', stiffness: 200, damping: 12 },
                }}
              >
                {'\u{1F411}'}
              </motion.span>
            ...
            >
              &ldquo;Make yourself an ark&rdquo; &mdash; Genesis 6:14
            </motion.p>
          </div>
        </motion.div>
      )}
