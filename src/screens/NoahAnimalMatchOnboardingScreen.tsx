...
import styles from './NoahAnimalMatchOnboardingScreen.module.css';
...
export function NoahAnimalMatchOnboardingScreen() {
  ...
  function handleSubmit() {
    ...
    navigate('/noah-animal-match/home', { replace: true });
  }
  ...
  return (
    <div className={styles.container}>
      ...
      >
        <h1 className={styles.title}>Welcome to Noah's Animal Match</h1>
