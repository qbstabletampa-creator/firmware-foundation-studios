...
import styles from './BibleBrickBreakerSettingsScreen.module.css';

export function BibleBrickBreakerSettingsScreen() {
  ...
  return (
    <ScreenShell showTabs={false}>
      <PageHeader title="Settings" backTo="/bible-brick-breaker/more" />
